...
public class Task4Test {
    ...
    void test2() {
        // given
        Animal animal1 = new Animal("CatFirst", Animal.Type.CAT, Animal.Sex.F, 10, 10, 8, true);
        Animal animal2 = new Animal("Cat", Animal.Type.CAT, Animal.Sex.M, 12, 9, 7, false);
        Animal animal3 = new Animal("Dog", Animal.Type.DOG, Animal.Sex.F, 4, 8, 6, true);
        Animal animal4 = new Animal("Dog", Animal.Type.DOG, Animal.Sex.M, 6,7, 5, false);
        Animal animal5 = new Animal("Bird", Animal.Type.BIRD, Animal.Sex.F, 4, 6, 4, false);
        Animal animal6 = new Animal("Fish", Animal.Type.FISH, Animal.Sex.M, 1, 5, 3, false);
        Animal animal7 = new Animal("Spider", Animal.Type.SPIDER, Animal.Sex.F, 4, 2, 1, false);
        Animal animal8 = new Animal("Sss", Animal.Type.SPIDER, Animal.Sex.M, 3, 1, 3, true);
        List<Animal> animals = new ArrayList<>(List.of(animal1, animal2, animal3, animal4, animal5, animal6, animal7, animal8));
    ...
    void test3() {
        // given
        Animal animal1 = new Animal("CatFirst", Animal.Type.CAT, Animal.Sex.F, 10, 10, 8, true);
        List<Animal> animals = new ArrayList<>(List.of(animal1));
