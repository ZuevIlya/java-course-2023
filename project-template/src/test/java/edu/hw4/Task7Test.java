...
public class Task7Test {
    ...
    void test1() {
        ...
        // when
        Animal result = Task7.getOldestAnimal(animals, 1);
    ...
    void test2() {
        ...
        // when
        Animal result = Task7.getOldestAnimal(animals, 4);

        // then
        assertEquals(result, animal3);
    }
    ...
    void test3() {
        ...
        // when
        Animal result = Task7.getOldestAnimal(animals, 100);
